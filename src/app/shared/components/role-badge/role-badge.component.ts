...
@Component({
  ...
  template: `
    ...
    >
      ...
      <svg *ngIf="showIcon && role?.system" class="mr-1 h-3 w-3" fill="currentColor" viewBox="0 0 20 20">
...
export class RoleBadgeComponent {
  ...
  getBadgeClasses(): string {
    ...
    const baseClasses = getRoleColor(this.role.name, this.role.system ?? true);
